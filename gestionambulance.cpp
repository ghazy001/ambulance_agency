...
#include <QDir>
#include "arduino.h"
gestionAmbulance::gestionAmbulance(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::gestionAmbulance)
{
    ui->setupUi(this);
   ...
   //parkin arduino
   ui->parking->setModel(A.afficherAr());
   // stats
...
//$$$$$$$$$$$$$$$$
   AR.connect_arduino();
   datafromArduino="";
   connect(AR.getserial(),&QSerialPort::readyRead,[&]() {AR.getserial()->waitForReadyRead(10);datafromArduino+=AR.read_from_arduino();});
   A_connection=connect(AR.getserial(),&QSerialPort::readyRead,[this](){gestionArduino();});
}

gestionAmbulance::~gestionAmbulance()
{
    delete ui;
...
void gestionAmbulance::gestionArduino()
{
    disconnect(A_connection);
    qDebug()<<datafromArduino<<endl;
    QMessageBox msgBox;
    if(datafromArduino=="in"){
        QSqlQuery query;
        query.prepare("INSERT INTO PARKING (DATEE, INOUT) "
                      "VALUES (:DATEE, :INOUT)");
        query.bindValue(":DATEE", QDateTime::currentDateTime());
        query.bindValue(":INOUT", 1);
        query.exec();
        msgBox.setText("car is innnnnn ");
        msgBox.exec();
    }
    else if(datafromArduino=="out"){
        QSqlQuery query;
        query.prepare("INSERT INTO PARKING (DATEE, INOUT) "
                      "VALUES (:DATEE, :INOUT)");
        query.bindValue(":DATEE", QDateTime::currentDateTime());
        query.bindValue(":INOUT", 0);
        query.exec();
        msgBox.setText("car is out ");
        msgBox.exec();
    }
    datafromArduino.clear();
    A_connection=connect(AR.getserial(),&QSerialPort::readyRead,[&](){gestionArduino();});
}



void gestionAmbulance::on_insertButton_2_clicked()
{
    QMessageBox msgBox;
...
void gestionAmbulance::on_deleteButton_clicked()
{
ambulance A1;
...
void gestionAmbulance::on_pushButton_clicked()
{
...
void gestionAmbulance::on_pushButton_2_clicked()
{
    //Update
...
bool gestionAmbulance::postrequest(QString smsmsg,QString phonenumber)
{
    bool tried=false;
...
void gestionAmbulance::on_tab_ambulance_clicked(const QModelIndex &index)
//£££££££Remp
{
...
// trier
void gestionAmbulance::on_comboBox_activated(const QString &arg1)
{
    if (arg1=="matricule")
...
//pdf
void gestionAmbulance::on_pushButton_3_clicked()
...
//sms
void gestionAmbulance::on_pushButton_4_clicked()
...
//rechercher
void gestionAmbulance::on_chercher_textEdited(const QString &arg1)
{
...
//clandrier
void gestionAmbulance::on_calendarWidget_clicked(const QDate &date)
{
...
void gestionAmbulance::on_pushButton_5_clicked()
{
...
void gestionAmbulance::on_updateNote_clicked()
{
...
void gestionAmbulance::on_deleteNote_clicked()
{
...
void gestionAmbulance::on_btn_add_clicked()
{
...
void gestionAmbulance::on_pushButton_6_clicked()
{
